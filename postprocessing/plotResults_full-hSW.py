...
def plot_monospar_deflection(skip_num):
    ### monoplane spar ###
    os.chdir('D:\\data\\2012-03-05 (truegrid-VABS-DYMORE mesh refinement)\\grid_density_1\\dymore\\FIGURES')
...
def load_bispar07_displacement():
    ### biplane spar 7 ###
    os.chdir('D:\\data\\2012-05-17 (biplane spars, no root joint, full shear web height)\\07-bispar-rj629-g100\\FIGURES')
...
def load_bispar07_force():
    ### biplane spar 7 ###
    os.chdir('D:\\data\\2012-05-14 (biplane spars, no root joint)\\07-bispar-rj629-g100\\FIGURES')
...
plot_monospar_deflection(skip_every)
(bispar_upper, bispar_lower) = load_bispar07_displacement()
plot_bispar_deflection(bispar_upper, bispar_lower, skip_every)
plt.xlabel('span [m]')
...
(bispar_upper, bispar_lower) = load_bispar07_force()
