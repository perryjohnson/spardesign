...
maxAR = 20
vabs_filename = 'test_input_file_SW.dat'
...
for spar_stn in range(startrange,endrange):
    ...
    total_number_of_nodes = SW_L_biaxL_number_of_nodes + SW_L_foam_number_of_nodes + SW_L_biaxR_number_of_nodes
    ...
    total_number_of_elements = SW_L_biaxL_number_of_elements + SW_L_foam_number_of_elements + SW_L_biaxR_number_of_elements
