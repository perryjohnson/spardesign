 ...
 set output '.\FIGURES\curveSparQcv1Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "curveSpar";
 set xlabel "X1 [m]";
 ...
 reset
 set terminal png small size 1000,1000;
 set output '.\FIGURES\curveSparQcv2Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "curveSpar";
 set xlabel "X1 [m]";
 ...
 reset
 set terminal png small size 1000,1000;
 set output '.\FIGURES\curveSparQcv3Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "curveSpar";
 set xlabel "X2 [m]";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\orientationSpar.png';
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQm00Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQm02Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQm03Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQm33Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQm23Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQm22Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk11Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk12Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk22Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk13Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk23Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk33Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk14Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk24Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk34Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk44Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk15Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk25Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk35Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk45Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk55Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk16Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk26Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk36Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk46Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk56Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQk66Q.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
 ...
 reset
 set terminal png small size 1000, 750;
 set output '.\FIGURES\propSparQmucQ.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title "propSpar";
 set xlabel "ETA";
